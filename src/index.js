...
// Trust first proxy (important for cloud deployments)
if (process.env.NODE_ENV === "production") {
  app.set("trust proxy", 1);
  console.log(
    "🔧 Production mode: Trusting first proxy for secure connections"
  );
}
...
// Routes
app.get("/", (req, res) => {
  res.json({ message: "Welcome to Signalist Backend API v3" });
});
